    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="p-9 space-y-6">
        ...
        <section className="text-center mt-6">
          <h2 className="text-[35px] font-bold text-primary mb-4">Jogar</h2>
        ...
        <section className="text-center mt-6">
          <h2 className="text-[35px] font-bold text-primary mb-4">Resultados</h2>
        ...
        <section className="text-center mt-6 pb-20">
          <h2 className="text-[35px] font-bold text-primary mb-4">Ganhadores do Dia</h2>
          <div className="space-y-3">
            {winners.map((winner) => (
