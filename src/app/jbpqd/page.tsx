...
export default function AnimalGridPage() {
  ...
  return (
    <div className="text-primary flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="text-primary flex-grow relative overflow-hidden">
        ...
        <div className="text-primary relative z-10 w-full max-w-lg mx-auto p-4  md:p-6 lg:p-8 content-area-bg rounded-lg shadow-lg my-4">
          ...
          <h2 className="text-primary text-foreground text-xl md:text-2xl font-bold mb-4">Posição, quantia e divisão</h2>

   
          <div className="text-primary mb-6">
            <p className="text-primary text-foreground text-primary text-lg md:text-xl font-bold mb-3">Selecione a posição:</p>
                ...
                <label key={position} className="text-primary flex items-center cursor-pointer">
                  ...
                  <span
                    className={`
                      ...
                      ${selectedPosition === position ? 'border-primary bg-primary' : 'border-gray-400 bg-white'}
                    `}
                  >
                  ...
                  <span className="text-primary text-foreground text-base">{position}</span>
                </label>
              ))}
            </div>
          </div>
          ...
          <div className="text-primary mb-6">
            <p className="text-primary text-foreground text-lg md:text-xl font-bold mb-2">Informe o valor:</p>
            <p className="text-primary text-foreground text-sm mb-4">
            ...
            <div className="text-primary relative flex items-center mb-4">
              <span className="text-primary absolute left-3 text-foreground text-xl font-bold">R$</span>
              <input
                type="text"
                value={betAmount}
                onChange={handleBetAmountChange}
                inputMode="numeric"
                className="text-primary w-full pl-12 pr-4 py-3 bg-gray-100 rounded-lg text-foreground text-2xl md:text-3xl font-bold focus:outline-none focus:ring-2 focus:ring-primary"
              />
            </div>
